        ...
        SwingUtilities.invokeLater(
            () -> {
                try {
                    ...
                    // Observer: GamePanel beobachtet GameState-Änderungen der GameEngine
                    engine.addGameStateObserver(panel);

                    // Observer: GameEngine beobachtet Direction-Eingaben aus dem GamePanel
                    panel.setDirectionObserver(engine);
